...
<div id="myPrintArea">
	...
	<table width="489" border="1">
		...
		<tr>
		  ...
		  <td>&nbsp;<fmt:formatNumber type="number" value="${diagnosticList[0].yiZhen }" maxFractionDigits="0"/></td>
		  <td>&nbsp;<fmt:formatNumber type="number" value="${diagnosticList[0].fuHe/(diagnosticList[0].fuHe + diagnosticList[0].buFu + diagnosticList[0].yiZhen) * 100 }" maxFractionDigits="2"/>%</td>
		  <td>&nbsp;<fmt:formatNumber type="number" value="${diagnosticList[0].yiZhen/(diagnosticList[0].fuHe + diagnosticList[0].buFu + diagnosticList[0].yiZhen) * 100 }" maxFractionDigits="2"/>%</td>
		</tr>
		<tr>
		  <td>本期</td>
		  ...
		  <td>&nbsp;<fmt:formatNumber type="number" value="${diagnosticList[1].yiZhen }" maxFractionDigits="0"/></td>
		  <td>&nbsp;<fmt:formatNumber type="number" value="${diagnosticList[1].fuHe/(diagnosticList[1].fuHe + diagnosticList[1].buFu + diagnosticList[1].yiZhen) * 100 }" maxFractionDigits="2"/>%</td>
		  <td>&nbsp;<fmt:formatNumber type="number" value="${diagnosticList[1].yiZhen/(diagnosticList[1].fuHe + diagnosticList[1].buFu + diagnosticList[1].yiZhen) * 100 }" maxFractionDigits="2"/>%</td>
		</tr>
	</table>
		<br/>
...
$(function(){
	...
	$("#search").click(function(){
		...
		if(dateStart == "" || dateEnd == ""){
			...
			var url = "${contextPath }/report/search/dateStart/" + $("#dateStart").val() + "/dateEnd/" + $("#dateEnd").val() + "/parm/44";
