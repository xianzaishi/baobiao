...
<div id="myPrintArea">
	...
	<table width="316" border="1" align="center" bordercolor="#000000">
		<tr>
			<td width="150">科室</td>
			<td width="150">平均病床工作日</td>
		</tr>
		<c:forEach items="${bcgzrDtoList }" var="bcgzrDtoList">
		<tr>
			<td>&nbsp;${bcgzrDtoList.dept }</td>
			<td>&nbsp;<fmt:formatNumber type="number" value="${bcgzrDtoList.shiJiZhanYongZongChuangRiShu/bcgzrDtoList.pingJuKaiFangChuangRiShu }" maxFractionDigits="2"/></td>
		</tr>
		</c:forEach>
	</table>
...
<div style="float:left; margin-left: 40px;">
	<br/>
	<p style="font-size:80%">平均开放病床数：实际开放总床日数÷本年日历数（365）。</p>
	<p style="font-size:80%">病床工作日：实际占用总床日数÷平均开放病床数(1061)。</p>
</div>
...
$(function(){
	...
	$("#search").click(function(){
		...
		if(dateStart == "" || dateEnd == ""){
			...
			var url = "${contextPath }/report/search/dateStart/" + $("#dateStart").val() + "/dateEnd/" + $("#dateEnd").val() + "/parm/33";
