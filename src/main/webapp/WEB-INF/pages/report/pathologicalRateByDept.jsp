...
<div id="myPrintArea">
	...
	<table width="316" border="1" align="center" bordercolor="#000000">
		<tr>
			<td width="150">科室</td>
			<td width="150">符合数</td>
			<td width="150">不符合数</td>
			<td width="150">总数</td>
			<td width="150">诊断符合率(%)</td>
		</tr>
		<c:forEach items="${pathologicalList }" var="pathologicalList">
		<tr>
			<td>&nbsp;${pathologicalList.name }</td>
			<td>&nbsp;<fmt:formatNumber type="number" value="${pathologicalList.fuhe }" maxFractionDigits="2"/></td>
			<td>&nbsp;<fmt:formatNumber type="number" value="${pathologicalList.bufu }" maxFractionDigits="2"/></td>
			<td>&nbsp;<fmt:formatNumber type="number" value="${pathologicalList.fuhe + pathologicalList.bufu }" maxFractionDigits="2"/></td>
			<td>&nbsp;<fmt:formatNumber type="number" value="${(pathologicalList.fuhe/(pathologicalList.fuhe+pathologicalList.bufu)) * 100 }" maxFractionDigits="2"/></td>
		</tr>
		</c:forEach>
	</table>
...
$(function(){
	...
	$("#search").click(function(){
		...
		if(dateStart == "" || dateEnd == ""){
			...
			var url = "${contextPath }/report/search/dateStart/" + $("#dateStart").val() + "/dateEnd/" + $("#dateEnd").val() + "/parm/28";
